...
$descdir = $ENV{APP_ROOT} . "/Descriptions/";
...
my $infile = $$descdir . $query . ".txt";
if (-e "$infile"){goto LAST;}

#If in the Blanks File already, skip it
open (BLANKS, $descdir . "Blank_Descriptions.txt");
@blanks = <BLANKS>;
close BLANKS;
...
$outfile = $descdir . "Messed_Up_Descriptions.txt";
...
$outfile = $descdir . "Blank_Descriptions.txt";
